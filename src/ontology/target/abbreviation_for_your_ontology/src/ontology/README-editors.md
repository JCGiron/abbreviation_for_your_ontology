These notes are for the EDITORS of abbreviation_for_your_ontology
...
Make sure you have an ID range in the [idranges file](abbreviation_for_your_ontology-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [abbreviation_for_your_ontology-edit.owl](abbreviation_for_your_ontology-edit.owl)

** DO NOT EDIT abbreviation_for_your_ontology.obo OR abbreviation_for_your_ontology.owl in the top level directory **

[../../abbreviation_for_your_ontology.owl](../../abbreviation_for_your_ontology.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/your_GitHub_user_name/name_of_repository) for details.
 ...
 * [abbreviation_for_your_ontology-idranges.owl](abbreviation_for_your_ontology-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/abbreviation_for_your_ontology_terms.txt file
...
Note: the abbreviation_for_your_ontology_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as abbreviation_for_your_ontology.owl and abbreviation_for_your_ontology.obo and places
 ...
 * https://github.com/your_GitHub_user_name/name_of_repository/releases
 * https://github.com/your_GitHub_user_name/name_of_repository/releases/new
...
what is in the `owl:versionIRI` of the derived abbreviation_for_your_ontology.owl (`data-version` in
abbreviation_for_your_ontology.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/abbreviation_for_your_ontology.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/abbreviation_for_your_ontology/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/your_GitHub_user_name/name_of_repository.svg?branch=master)](https://travis-ci.org/your_GitHub_user_name/name_of_repository)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/your_GitHub_user_name](https://travis-ci.org/profile/your_GitHub_user_name)
 2. click the "Sync account" button
 3. Click the tick symbol next to name_of_repository
